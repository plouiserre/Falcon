    ...
    public class SimulateParsingSimplePage
    {
        ...
        private static TagModel GetTagHtml()
        {
            ...
            var htmlTag = new TagModel()
            {
                ...
                Content = HtmlPageSimpleData.GetHtml(TagHtmlSimple.htmlPage).Replace("<html lang=\"en\" dir=\"auto\" xmlns=\"http://www.w3.org/1999/xhtml\">", string.Empty).Replace("</html>", string.Empty),
        ...
        private static TagModel GetHeadTag()
        {
            var metaCharsetTag = new TagModel()
            {
                ...
                TagStart = HtmlPageSimpleData.GetHtml(TagHtmlSimple.metaCharset)
            };
            var metaViewPort = new TagModel()
            {
                ...
                NameTag = NameTagEnum.meta,
                TagStart = HtmlPageSimpleData.GetHtml(TagHtmlSimple.metaviewPort)
            };
        ...
        private static TagModel GetBodyTag()
        {
            ...
            var bodyTag = new TagModel()
            {
                ...
                TagFamily = TagFamilyEnum.WithEnd,
                Content = HtmlPageSimpleData.GetHtml(TagHtmlSimple.divIdContent),
        ...
        private static TagModel GetFirstPContent()
        {
            ...
            var pTag = new TagModel()
            {
                ...
                TagFamily = TagFamilyEnum.WithEnd,
                Content = HtmlPageSimpleData.GetHtml(TagHtmlSimple.pDeclarationText).Replace("<p class=\"declarationText\">", string.Empty).Replace("</p>", string.Empty),
