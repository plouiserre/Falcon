...
var locateLimitTag = new LocateLimitTag();
var determinateContent = new DeterminateContent(locateLimitTag);
...
var deleteUselessSpace = new DeleteUselessSpace(identifyStartTagEndTag, locateLimitTag);
...
var manageChildrenTag = new ManageChildrenTag(deleteUselessSpace, identifyTag, identifyStartTagEndTag, locateLimitTag, determinateContent, attributeTagManager);
