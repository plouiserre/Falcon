...
var liParser = new LiParser(identifyTag, manageChildrenTag, attributeTagManager);
var htmlParsing = new HtmlParsing(doctypeParser, htmlParser, tableParser, articleParser, liParser, extractHtmlRemaining, attributeTagManager);
