...
var tbodyParser = new TBodyParser(identifyTag, manageChildrenTag, attributeTagManager);
var theadParser = new TheadParser(identifyTag, manageChildrenTag, attributeTagManager);
var htmlParsing = new HtmlParsing(doctypeParser, htmlParser, theadParser, tbodyParser, extractHtmlRemaining, attributeTagManager);
