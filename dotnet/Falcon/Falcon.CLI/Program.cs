...
var ulParser = new UlParser(identifyTag, manageChildrenTag, attributeTagManager);
var htmlParsing = new HtmlParsing(doctypeParser, htmlParser, tableParser, articleParser, ulParser, extractHtmlRemaining, attributeTagManager);
