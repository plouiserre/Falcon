namespace FalconEngine.Models
{
    public enum FamilyAttributeEnum
    {
        ...
        list, manifest, max, maxlength, min, minlength, media, method, multiple, name,
        ...
        placeholder, pattern, popover, popovertarget, popovertargetaction, readonlyAttr, required, rel,
        referrerpolicy, role, scheme, selected, spellcheck, size, sizes, src, step, style, tabindex, target,
